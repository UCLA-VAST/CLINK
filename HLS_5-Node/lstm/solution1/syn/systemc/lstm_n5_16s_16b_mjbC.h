...
#ifndef __lstm_n5_16s_16b_mjbC__HH__
#define __lstm_n5_16s_16b_mjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lstm_n5_16s_16b_mjbC) {
    ...
    SC_CTOR(lstm_n5_16s_16b_mjbC):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
