...
#ifndef __lstm_n5_16s_16b_mlbW__HH__
#define __lstm_n5_16s_16b_mlbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lstm_n5_16s_16b_mlbW) {
    ...
    SC_CTOR(lstm_n5_16s_16b_mlbW):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
